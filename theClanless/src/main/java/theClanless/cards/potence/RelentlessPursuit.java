...
public class RelentlessPursuit extends AbstractDynamicCard {

    public static final String ID = theClanlessMod.makeID("RelentlessPursuit");
    public static final String IMG = makeCardPath("RelentlessPursuit.png");
